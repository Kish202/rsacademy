          ...
          <div className="flex flex-col justify-center items-center sm:flex-row gap-4 pt-4 sm:justify-start">
            ...
            <a
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mr-1">
                <path d="M5 20.5v-17l14 8.5z"></path>
                <path d="M5 3.5L19 12 5 20.5z"></path>
                <path d="M3 22l12-9.5L3 3v19zm5-9.5L4 15V9l4 3.5zm8-4L5 3h15l-4 5.5zm0 9L16 13l4 5.5H8l8-5.5z"></path>
              </svg>
              Get on Play Store
            </a>
            <button
