    ...
    <div className="w-full min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col lg:flex-row items-center justify-between gap-12 max-md:gap-16">
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center lg:mr-16">
          <div 
            className="relative w-full max-w-md aspect-[4/3] transform rotate-3 hover:rotate-0 transition-all duration-300 ease-in-out group"
          >
            ...
            `}>
              <CardContent className="p-0 h-full">
                {/* Gray Image (Default) */}
                <div 
                  className="absolute inset-0 transition-opacity duration-700 will-change-opacity pointer-events-none group-hover:opacity-0"
                >
                ...
                <div className="absolute inset-0 transition-opacity duration-500 will-change-opacity pointer-events-none opacity-0 group-hover:opacity-100">
