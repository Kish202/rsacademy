...
const Service = () => {
  ...
  return (
    <section ref={sectionRef} className="container h-12 md:h-32">
      <div className={`grid grid-cols-4 w-full mx-auto translate-y-12 divde-x divide-blue-700 z- bg-yellow-600 place-self-center ${isDarkMode ? "bg-blue-950 dark:text-white/70" : "bg-yellow-700"} p-4 shadow-lg md:max-w-[800px] md:p-8 rounded-full`}>
