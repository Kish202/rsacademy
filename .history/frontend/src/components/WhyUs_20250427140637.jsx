...
const WhyUsSection = () => {
  ...
  const [currentImages, setCurrentImages] = useState([...imageUrls, ...imageUrls, ...imageUrls]); // Triple the images for seamless looping
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // When a full image has scrolled out, move it to the end for infinite scroll effect
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 overflow-hidden mx-6">
                ...
                >
                  {/* Images displayed in a continuous loop */}
                  {currentImages.map((src, imgIndex) => (
                    <div 
                      key={`img-${imgIndex}`} 
