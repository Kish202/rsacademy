      ...
      <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 space-y-6 z-10 max-md:mt-10 lg:ml-28 lg:pl-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Button className={`
              px-8 py-6 rounded-xl text-lg font-satoshi
              ${isDarkMode 
                ? 'bg-gradient-to-r from-blue-700 to-pink-600 hover:from-blue-800 hover:to-pink-700 text-yellow-100 shadow-[5px_5px_15px_rgba(0,0,0,0.3),-3px_-3px_10px_rgba(50,70,120,0.15)]' 
                : 'bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white shadow-[5px_5px_15px_rgba(0,0,0,0.1),-3px_-3px_10px_rgba(255,255,255,0.8)]'}`}>
              Get Started
            </Button>
            <Button variant="outline" className={`
              px-8 py-6 rounded-xl text-lg font-satoshi
              ${isDarkMode 
                ? 'border-yellow-500/30 text-yellow-300 hover:bg-blue-900/50 shadow-[inset_2px_2px_5px_rgba(0,0,0,0.2),inset_-2px_-2px_5px_rgba(70,100,150,0.1)]' 
                : 'border-blue-400 text-blue-700 hover:bg-blue-50 shadow-[inset_2px_2px_5px_rgba(163,177,198,0.3),inset_-2px_-2px_5px_rgba(255,255,255,0.8)]'}`}>
              Learn More
            </Button>
          </div>
        </div>
