    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-4 fixed top-0 z-50">
      ...
      >
        ...
        <div className="hidden lg:block p-3">
          <Button
            className="bg-neugray-bg px-6 py-2 rounded-lg shadow-neumorph-sm hover:shadow-neumorph active:shadow-neumorph-pressed transition-shadow text-neugray-accent font-medium"
          >
            Book a Demo
          </Button>
        </div>
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <Button
              className="w-full bg-neugray-bg py-2 rounded-lg shadow-neumorph-sm hover:shadow-neumorph active:shadow-neumorph-pressed transition-shadow text-neugray-accent font-medium"
              onClick={() => setIsMenuOpen(false)}
            >
              Book a Demo
            </Button>
