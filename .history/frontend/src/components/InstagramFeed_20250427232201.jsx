      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12" data-aos="fade-up" data-aos-duration="1000">
          <h2 className={`text-3xl md:text-6xl font-bold font-satoshi mb-4
            ${isDarkMode 
              ? 'bg-gradient-to-r from-yellow-300 via-pink-400 to-green-400 bg-clip-text text-transparen hover: from-yellow-200 hover:via-pink-300 to-green-400 bg-clip-text text-transparent' 
