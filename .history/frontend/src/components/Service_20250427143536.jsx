...
const Service =() =>{
 ...
 const isDarkMode = theme === 'dark'
    ...
    <section className="container h-12 md:h-32 ">
     <div className="grid grid-cols-4 w-full mx-auto -translate-y-12 divde-x divide-blue-700 place-self-center   bg-yellow-700 p-4 shadow-lg isark:bg-violet-800 dark:text-white/70 md:max-w-[800px]  md:p-8">
