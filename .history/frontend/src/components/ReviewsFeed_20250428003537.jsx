...
const TestimonialSection = () => {
  ...
  useEffect(() => {
    if (!document.getElementById('trustindex-script')) {
      ...
      script.src = '<script defer async src='https://cdn.trustindex.io/loader.js?8f93f8945523338f0146d60a1b4'></script>';
      script.defer = true;
      script.async = true;
  ...
  return (
    <section className="mt-0 pt-0 !bg-transparent">
      ...
      <div className={`trustindex-container ${isDarkMode ? 'dark-mode' : 'light-mode'} `}>
