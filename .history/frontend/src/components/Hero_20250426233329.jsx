...
const HeroSection = () => {
  ...
  return (
   ...
   `}>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col lg:flex-row items-center justify-between gap-12 max-md:gap-16 max-md:text-center">
        ...
        <div className="w-full lg:w-1/2 space-y-6 z-10 max-md:mt-10 lg:ml-28 lg:pl-10">
          ...
          <p className={`text-lg md:text-xl max-w-lg font-satoshi max-md:text-center
