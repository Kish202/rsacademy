                    ...
                    <li key={index} className="transition-all duration-300">
                      <a 
                        ...
                        <FaArrowRight 
                          ...
                          ${isDarkMode ? 'text-blue-400 hover:text-yellow-300 hover:translate-x-1 hover:rotate-90' : 'text-blue-600 hover:text-green-600 hover:translate-x-1 hover:rotate-90'}`} 
                        />
                        <span 
                  ...
                  {FooterLinks.map((link, index) => (
                    <li key={index} className="transition-all duration-300">
                      <a 
                        ...
                        <FaArrowRight 
                          className={`text-xs transition-all duration-300
                          ${isDarkMode ? 'text-blue-400 hover:text-yellow-300 hover:translate-x-1 ' : 'text-blue-600 hover:text-green-600 hover:translate-x-1 hover:rotate-90'}`} 
                        />
                        <span 
                          className={`transition-all duration-300
                          ${isDarkMode ? 'text-blue-100/70 hover:text-yellow-300 hover:translate-x-1' : 'text-blue-800/70 hover:text-green-600 hover:translate-x-1'}`}>
