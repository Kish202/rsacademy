...
const WhyUsSection = () => {
  ...
  const featureCardStyle = (index) => {
    ...
    return isDarkMode
      ? `bg-blue-950/50  shadow-[5px_5px_10px_rgba(0,0,0,0.3),-3px_-3px_8px_rgba(255,255,200,0.05)]`
      : `bg-white/60  shadow-[5px_5px_12px_rgba(0,0,0,0.08),-5px_-5px_12px_rgba(255,255,255,0.9)]`;
  };
