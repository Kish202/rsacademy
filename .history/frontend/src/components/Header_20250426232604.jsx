...
export default function Navbar() {
  ...
  return (
    <nav 
      className={`
        fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out m-3 md:ml-6 md:mr-6 md:mt-6
        ...
        `}>
          {menuItems.map((item) => (
            <Link
              ...
              to={item.path}
              className={`
                block px-3 py-2 rounded-md text-base font-medium font-satoshi text-center
                ${isDarkMode 
