      ...
      <section className="container" data-aos="fade-up" data-aos-duration="1000">
        <div className="grid md:grid-cols-3 py-8 md:px-10">
          ...
          <div className="py-8 px-4">
            <h1 className={`text-3xl font-bold sm:text-left text-justify mb-4 flex items-center gap-3 font-satoshi
              ${isDarkMode 
          ...
          <div className="container mx-auto px-4 mb-3 mt-0 absolute bottom-0 left-1/2 transform -translate-x-1/2">
